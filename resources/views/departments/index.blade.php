            ...
            <div class="col-md-6 mt-3">
                <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                    <div>
                        ...
                        <i class="bx bx-plus me-1"></i>新增部門</a>
                    </div>
                    <!--
                    <div>
                        <a href="#" data-bs-toggle="modal" data-bs-target=".add-new" class="btn btn-primary">
                        <i class="bx bx-plus me-1"></i>修改部門</a>
                    </div>
                    <div>
                        <a href="#" data-bs-toggle="modal" data-bs-target=".add-new" class="btn btn-primary">
                        <i class="bx bx-plus me-1"></i>刪除部門</a>
                    </div>                        
                ...
                <div class="modal-dialog modal-xl modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myExtraLargeModalLabel">新增部門</h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="AddNew-Username">部門名稱</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="AddNew-Username">部門地址</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">部門規模</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="AddNew-Username">管理者ID</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="AddNew-Username">管理者名稱</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="AddNew-Phone">部門簡介</label>
